# RemoteClaude iOS App - プライバシーポリシー
...
## 📱 RemoteClaude プライバシーポリシー

RemoteClaude開発チーム（以下「当チーム」）は、RemoteClaudeアプリケーション（以下「本アプリ」）をご利用いただくユーザーのプライバシーを重視し、個人情報の保護に取り組んでおります。
